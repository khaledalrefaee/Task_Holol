                                                        ...
                                                        <div class="pro-cate">
                                                            ...
                                                            @isset($product -> cat)
                                                                <div>
                                                                        ...
                                                                        <span><a
                                                                                href="{{route('category',$product -> id )}}"
                                                                                title="Computer &amp; Networking">{{$product ->cat-> name}}</a></span>
                                                        ...
                                                        <div class="pro-tag">
                                                            <label class="control-label">price :</label>
                                                                ...
                                                                <div>
                                                                        ...
                                                                        <span><a href="">{{$product -> selling_price}}</a></span>
                                        ...
                                        <div class="product-miniature js-product-miniature item-two first_item"
                                            ...
                                            <div class="product-cat-content">
                                                ...
                                                <div class="product-title" itemprop="name">
                                                    <a href="{{route('product.details',$_product -> id)}}">{{$_product -> name}}</a></div>

                                            </div>
                                            <div class="thumbnail-container">

                                                <a href="{{route('product.details',$_product -> id)}}"
